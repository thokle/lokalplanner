...
Public Class FrmBladStamData
  ...
  Private Sub FrmBladStamData_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub EndEdit()
        ...
        savePriser(txtUgeavisID.Value, cboPriserÅr.Value, cboPrislister.Value)
        SetStatusLabel()
    ...
    Private Sub SaveData()
        ...
        If frmMain.BrugerNavn = "LEJ" OrElse frmMain.BrugerNavn = "LW" OrElse frmMain.BrugerNavn = "AN" OrElse frmMain.BrugerNavn = "CWS" OrElse frmMain.BrugerNavn = "SMJ" OrElse frmMain.BrugerNavn = "LVL" OrElse frmMain.BrugerNavn = "TK" OrElse frmMain.BrugerNavn = "LHJ" Then
            If btnGem.Text.Contains("Gem") Then
                ...
                ' Me.TblBladStamdataTableAdapter.InsertQuery(txtNavn.Value, _nytBladId, txtAdresse.Value, txtAdresse2.Value, cboPostNr.Value, medTlf.Value, medFax.Value, txtCVR.Value, medFax.Value, txtKontaktperson.Value, optHovedgruppe.Value, cboMåned.Value, cboÅr.Value, txtEjerforhold.Value)
                ...
                Dim i As Integer
                ' Me.TblBladStamdataTableAdapter.Insert(txtNavn.Value, _nytBladId)
                Me.TblPrislisterPrBladPrÅrTableAdapter.InsertPrisliste(_nytBladId, Date.Now.Year, 1)
                For i = 1 To 53
                    TblPrislisterPrBladPrUgeTableAdapter.InsertPrislistePrBladPrÅrPrUge(Date.Now.Year, _nytBladId, i, 1)
                Next i
    ...
    Private Sub cboPriserÅr_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboPriserÅr.ValueChanged
        ...
        If Me.DstBladStamdata.tblPrislisterPrBladPrUge.IsInitialized Then
            If cboPriserÅr.Value Then
                ' Me.TblPrislisterPrBladPrUgeTableAdapter.FillByÅr(Me.DstBladStamdata.tblPrislisterPrBladPrUge, cboPriserÅr.Value)
            Else
                ' Me.TblPrislisterPrBladPrUgeTableAdapter.FillByÅr(Me.DstBladStamdata.tblPrislisterPrBladPrUge, Date.Now.Year)
            End If
        End If
