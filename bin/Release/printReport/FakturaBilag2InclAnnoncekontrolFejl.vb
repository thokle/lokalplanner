...
Public Class FakturaBilag2InclAnnoncekontrolFejl
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "FakturaBilag2InclAnnoncekontrolFejl.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "printRapport.FakturaBilag2InclAnnoncekontrolFejl.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_MedieplanNrParam() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_VersionParam() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedFakturaBilag2InclAnnoncekontrolFejl
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FakturaBilag2InclAnnoncekontrolFejl = New FakturaBilag2InclAnnoncekontrolFejl()
        rpt.Site = Me.Site
        Return rpt
    End Function
