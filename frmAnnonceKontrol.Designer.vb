...
Partial Class frmAnnonceKontrol
    ...
    Private Sub InitializeComponent()
        ...
        Dim UltraGridColumn7 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("Navn")
        Dim UltraGridColumn8 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("IndrykningsUge", -1, Nothing, 0, Infragistics.Win.UltraWinGrid.SortIndicator.Descending, True)
        Dim UltraGridColumn9 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("BladID")
        ...
        UltraGridColumn7.Header.Caption = "Lokal Ugeavis"
        UltraGridColumn7.Header.VisiblePosition = 0
        UltraGridColumn7.Width = 764
        UltraGridColumn8.Header.Caption = "Uge"
        UltraGridColumn8.Header.VisiblePosition = 1
        UltraGridColumn8.Width = 372
